<template>
    <div class="container">
        <div class="jumbotron bg-white">
            ...
            <p class="text-right"><router-link to="/">Back</router-link></p>
            <hr class="my-4">
                ...
                <table class="table table-hover table-borderless align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>10000</td>
                                <td>
                                    <button class="btn btn-outline-dark" href="#">입금</button>
                                    <button class="btn btn-outline-dark" href="#">출금</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <table class="table table-hover table-borderless">
                        <thead>
                            <tr class="table-dark">
                                ...
                                <th scope="col"><button class="btn btn-outline-dark text-white">출금 주소 관리</button></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>10000</td>
                                <td>
                                    <button class="btn btn-outline-dark" href="#">인출</button>
                                    <button class="btn btn-outline-dark" href="#">구매</button>
                                    <button class="btn btn-outline-dark" href="#">입금</button>
                                    <button class="btn btn-outline-dark" href="#">출금</button>
                                </td>
                            </tr>
