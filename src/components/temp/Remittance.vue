                ...
                <div class="card-body">
                    ...
                    <form class="">
                        <div class="form-group row">
                            <label for="inputAmounts" class="col-sm-2 col-form-label">보낼 금액</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control w-75" id="inputAmounts" placeholder="송금할 금액 입력">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputAddress" class="col-sm-2 col-form-label">받는 분</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control w-75" id="inputAddress" placeholder="받는 분(계좌번호 또는 연락처)">
                            </div>
                        </div>
