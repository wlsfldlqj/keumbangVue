                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <b>{{ receiver }}</b>계좌로 <b>Gold 토큰 {{ tokens }}개</b> 송금합니다.
                                        <p class="mute">
                                            결제 수수료
...
var data  = { transfer, wallets,  tokens, receiver, payment, fee }
export default {
  data() {
    return data
  },
  ...
  methods: {
      ...
      submit2(){
        ...
        sessionStorage.gt -= this.tokens
        sessionStorage.krw += this.tokens * 42000 * 1.1
        if(this.payment == 'krw')
