<template>
    <div class="">
        <div class="jumbotron bg-white p-s">
            ...
            <p class="text-right"><router-link to="/login">Back</router-link></p>
            <hr class="my-4">
            <p>보유하신 지갑별 자산 현황과 거래 내역을 확인하실 수 있습니다.</p>
            <div class="card" id="card-wallet-krw">
                ...
                <table class="table table-hover table-borderless align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>10000</td>
                                <td>
                                    <button class="btn btn-link" href="#">입금</button>
                                    <button class="btn btn-link" href="#">출금</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <!-- </div> -->
            <!-- <div class="card" id="card-wallet-gold"> -->
                ...
                <table class="table table-hover table-borderless">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>10000</td>
                                <td>
                                    <button class="btn btn-link"><router-link :to="'transfer'">이체</router-link></button>
                                    <button class="btn btn-link" href="#">구매</button>
                                    <button class="btn btn-link"><router-link :to="'withdraw'">인출</router-link></button>
